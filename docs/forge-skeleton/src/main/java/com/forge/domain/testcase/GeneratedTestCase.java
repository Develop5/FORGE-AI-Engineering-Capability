...
public final class GeneratedTestCase {
    ...
    private final List<String> targetRequirementIds;
    ...
    public GeneratedTestCase(
        ...
        this.targetRequirementIds =
                copyList(targetRequirementIds, "targetRequirementIds");
    }
    ...
    public List<String> targetRequirementIds() {
        return targetRequirementIds;
    }
